...
install() {
    ...
    for x in "complete" "prepare" "subsequent" "diskful" "diskful-subsequent"; do
    ...
    # prepare setups ignition
    install_ignition_unit ignition-setup-base.service ignition-prepare.target
    install_ignition_unit ignition-setup-user.service ignition-prepare.target
    # boot.mount is dynamically pulled in later
    inst_simple "$moddir/boot.mount" "$systemdsystemunitdir/boot.mount"
    ...
    # device-mapper targets may not be ready when the symlinks are created
    install_ignition_unit ignition-diskful-udev.service    ignition-diskful-subsequent.target
    install_ignition_unit ignition-diskful-udev.service    ignition-diskful.target
